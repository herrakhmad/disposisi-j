			...
			<div class="card-body">
				<form action="<?php echo site_url('admin/user/save') ?>" method="post">
					<div class="mb-3">
						...
						<div class="mb-3">
							<label for="phone">PHONE</label><input class="form-control" type="number" name="phone"
								placeholder="PHONE" required />
						</div>
						<div class="mb-3"><label for="email">EMAIL</label><input class="form-control" type="text"
								name="email" placeholder="EMAIL" required />
						</div>
						<div class="mb-3"><label class="control-label col-md-3 col-sm-3 col-xs12">PASSWORD</label><input
