                        ...
                        <tbody>
                            ...
                            foreach ($surat as $suratdata) {
                                ...
                                <div>
                                    ...
                                    <a href=" . base_url('surat_ajuan/delete/' . $suratdata->id) . " class='btn btn-sm btn-danger'onclick='return confirm(\"Ingin mengapus data Surat Ajuan ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                </div>
                                </td>
                                </tr>";
                                $no++;
